...
import { StatusBadge, ConfidenceBar, SourceBadge, Spinner, Tabs } from '@components/clm/ui/SharedUI';
...
export default function DocumentViewer() {
  ...
  const returnTo = searchParams.get('from') || `/clm/workflows/${workflowId}`;
