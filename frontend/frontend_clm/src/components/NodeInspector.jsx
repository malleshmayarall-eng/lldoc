...
import { workflowApi, triggerBlobDownload } from '../api/clmApi';
                  ...
                  <td key={col.key} className="px-3 py-2.5 align-top whitespace-nowrap">
                    {col.key === 'status' ? (
                      ...
                      <div className="max-w-[220px]">
                        <Link
                          to={`/documents/${workflowId}/${doc.id}`}
                          target="_blank"
                          onClick={(e) => e.stopPropagation()}
                    ...
                    ) : col.key === 'action_status' || col.key === 'val_status' || col.key === 'gate_status' || col.key === 'listener_status' ? (
